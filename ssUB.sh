...
mbedtls_url="https://github.com/Mbed-TLS/mbedtls/archive/refs/tags/mbedtls-3.2.1.tar.gz"
...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/Kyo628/1keyinstall/master/shadowsocks-libev-debian"
}
